...
public class MainActivity extends AppCompatActivity {
    ...
    FloatingActionButton add_book, add_publisher, add_branch, add_member, add_author, add_bookCopy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_bookCopy = findViewById (R.id.add_bookCopy);
        ...
        add_bookCopy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
